        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 py-8 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li className="pt-2">
                <a href="https://www.welj-ht.com/user/login" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold py-2 px-3 rounded-lg transition-colors w-[150px] mb-2">
                  <LogIn size={16} />
                  <span>{t('nav.login')}</span>
                </a>
                <a href="https://www.welj-ht.com/user/signup" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 border border-red-600 text-red-500 hover:bg-red-600/10 text-sm font-semibold py-2 px-3 rounded-lg transition-colors w-[150px]">
                  <UserPlus size={16} />
